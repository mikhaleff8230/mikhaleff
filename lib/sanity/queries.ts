...
export const localizedHomepageQuery = defineQuery(`*[_type == "homepage"][0] {
  ...
  filmEnabled,
  "filmSrc": coalesce(filmFile.asset->url, filmExternalUrl),
  "filmPosterSrc": filmPoster.asset->url,
  "filmPosterAlt": coalesce(${localized("filmPoster.alt")}, ${localized("filmTitle")}, "Homepage film"),
  "filmPosterWidth": filmPoster.asset->metadata.dimensions.width,
  "filmPosterHeight": filmPoster.asset->metadata.dimensions.height,
  "filmEyebrow": ${localized("filmEyebrow")},
  "filmTitle": ${localized("filmTitle")},
  "filmCaption": ${localized("filmCaption")},
  "filmLinkLabel": ${localized("filmLinkLabel")},
