...
export type Homepage = {
  ...
  filmEyebrow?: LocalizedString;
  filmTitle?: LocalizedString;
  filmCaption?: LocalizedText;
  filmLinkLabel?: LocalizedString;
...
// Query: *[_type == "siteSettings"][0] {  siteTitle, email, instagram, telegram, whatsapp, youtube, facebook,  "location": coalesce(  select($locale == "ru" => location.ru, $locale == "zh" => location.zh, location.en),  location.en, location.ru, location.zh),  "siteDescription": coalesce(  select($locale == "ru" => siteDescription.ru, $locale == "zh" => siteDescription.zh, siteDescription.en),  siteDescription.en, siteDescription.ru, siteDescription.zh),  "shareImage": defaultShareImage.asset->url,  "navigation": navigationLabels[]{key, "label": select($locale == "ru" => label.ru, $locale == "zh" => label.zh, label.en)}}
...
export type LocalizedHomepageQueryResult = {
  ...
  filmEnabled: boolean | null;
  filmSrc: string | null;
  filmPosterSrc: string | null;
  filmPosterAlt: string | "Homepage film";
  filmPosterWidth: number | null;
  filmPosterHeight: number | null;
  filmEyebrow: string | null;
  filmTitle: string | null;
  filmCaption: string | null;
  filmLinkLabel: string | null;
